...
<script type="text/javascript" src="script/Formulario_1.js">
	...
	<title>Inicia sesi&oacute;n Alumno</title>
</head>
<body>
	...
	<div class="Contenido">
		<div align="center">
			...
			<form method="post" action="isAlumno.jsp">
			<!---SON LOS CAMPOS DE TEXTO, BOTONES ETC.. -->
                        <div class="campo" ><span class="formi letra">Boleta: &nbsp;</span>	<input id="Boleta" type="text" name="clave" class="texto" minlength="10" maxlength="10" value="<%=clave%>" onkeypress="validarBol();"></div>
				...
				<div class="ncx"><li class="formi letra">¿A&uacute;n no tienes una cuenta?</li> &nbsp;<a href="registroAlumno.jsp"> <li class="formi letra boton_t1">Registrate aqu&iacute;</li></a></div>
