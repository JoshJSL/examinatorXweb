    ...
    <body onload="<%=eror%>">
        ...
        <div class="contenido" >
            ...
            <div class="tablita" id="datos" >
                ...
                <br />
                <div class="gruposLabel"style="text-align: left">
                    Fotografia &nbsp;&nbsp;&nbsp;<img alt="Fotografia Alumno" width="150px"src="<%=foto%>">
                </div>
            ...
            <div class=" tablita" id="formu" style="text-align: left">
                ...
                <div >
                    <form method="post" action="cuenta.jsp" name="frm1">
                        ...
                        <br/><br/><br/><img style="width: 100px;" alt="Fotografia Alumno" src="<%=foto%>">
            ...
            <div class=" tablita" id="foto" style="display: none;">
                ...
                <br/><br/><br/><img style="width: 200px;" alt="Fotografia Alumno" src="<%=foto%>" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;
                <img id="nvImg" style="width: 200px;" alt="Fotografia Alumno nueva" src="<%=foto%>" />
                <br/><br/><br/>
